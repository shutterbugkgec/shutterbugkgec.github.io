...
function initOutdoor() {
  ...
  function a() {
    ...
    e.css("height", a - b - c);
    $(
      " #portfolio_horizontal_container .portfolio_item img , .port-desc-holder"
    ).css({
  ...
  $(".testimonials-slider-holder a.next-slide").on("click", function () {
    $(this)
      .closest(".testimonials-slider-holder")
      .find(testiSlider)
      .trigger("next.owl.carousel");
  });
  ...
  $(".show-hid-content").on("click", function () {
    if ($(this).hasClass("ishid")) showHidDes();
    else hideHidDes();
  });
